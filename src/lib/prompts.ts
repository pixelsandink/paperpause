export const promptDatabase: string[] = [
  ...
  // Fun, quirky & thought-provoking
  "Have you ever been disappointed by something you anticipated to be larger than life? What happened?",
  "If you could be an explorer, what would be your expedition?",
  "What strange thing would you like to happen at your funeral that would make people laugh?",
  "Do you make choices based on what's best or what's easiest?",
  "What do you always lose track of, besides time?",
  "How much money would it take to make you happy?",
  "When should you reveal a secret you promised not to reveal?",
  "What do you love to do for 'me' time?",
  "If your life was a commercial, what would the lyrics of your jingle be?",
  "What do you have a love/hate relationship with?",
  "Where do you lack discipline in your life?",
  "Do you have a 'chip' on your shoulder about something?",
  "Do you prefer texting or talking on the phone? Why?",
  "If you were to get a tattoo tomorrow, what would it be?",
  "If you could host any event, which would you like to host? Why?",
  "Have you ever felt trapped? Describe the situation.",
  "Where is your absolute favourite place to take a walk?",
  "If you began a podcast, what would it be about? What would you name it?",
  "What do you think is the most serious issue facing the planet right now?",
  "What is a reoccurring theme in your life? Explain it in detail.",
  "What is the most important thing you learned from your parents?",
  "What restores your faith in humanity?",
  "If you could steal one thing, what would it be? Why?",
  "Do you ever laugh at things you shouldn't?",
  "What's the biggest lie you once believed was true?",
  "What is your favourite activity for a girls'/guys' night out?",
  "Do you believe in aliens?",
  "What TV sitcom (any era) best represents your family?",
  "What is one memory you think of very often?",
  "If you had to be handcuffed to someone for 24 hours, who would it be? Why?",
  "What is one thing you want to take with you into next month, and what is something you want to leave behind?",
]
